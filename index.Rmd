...
For the best experience, if available to you, we suggest you use two monitors (or another two-screen setup such as a laptop and a tablet or two laptops). If you work at a healthcare institution, we also suggest to connect from a personal (not work-issued) laptop using a non-work wireless network in order to avoid issues caused by overzealous firewalls. We also suggest that you use either macOS or Windows. We highly recommend you use Google Chrome to access the RStudio Server training environment. 
...
- Install [R](https://cloud.r-project.org/) and [RStudio Desktop](https://rstudio.com/products/rstudio/download/) on your computer. We made a video with step by step instructions for installing these on macOS or Windows:
...
- [GitHub repository](https://github.com/skadauke/intro-to-r-for-clinicians-rmed2020) with the most up-to-date materials for this course
